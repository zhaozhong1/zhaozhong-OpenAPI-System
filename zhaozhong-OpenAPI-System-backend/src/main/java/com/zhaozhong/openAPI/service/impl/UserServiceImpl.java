...
import static com.zhaozhong.openAPI.constant.UserConstant.USER_LOGIN_STATE;
...
import com.zhaozhong.openAPI.mapper.UserMapper;
import com.zhaozhong.openAPI.model.dto.user.UserQueryRequest;
import com.zhaozhong.openAPI.model.entity.User;
import com.zhaozhong.openAPI.model.entity.UserKey;
import com.zhaozhong.openAPI.model.enums.UserRoleEnum;
import com.zhaozhong.openAPI.model.vo.LoginUserVO;
import com.zhaozhong.openAPI.model.vo.UserVO;
...
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService, InnerUserService {

    /**
     * 盐值，混淆密码
     */
    public static final String SALT = "zhaozhong";
