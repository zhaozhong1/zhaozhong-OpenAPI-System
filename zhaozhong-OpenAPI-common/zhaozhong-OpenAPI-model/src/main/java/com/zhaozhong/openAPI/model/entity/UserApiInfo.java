...
public class UserApiInfo implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        UserApiInfo other = (UserApiInfo) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
            && (this.getApiInfoId() == null ? other.getApiInfoId() == null : this.getApiInfoId().equals(other.getApiInfoId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getApiInfoId() == null) ? 0 : getApiInfoId().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", apiInfoId=").append(apiInfoId);
